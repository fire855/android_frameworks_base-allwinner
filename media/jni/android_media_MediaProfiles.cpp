...
android_media_MediaProfiles_native_get_video_encoder_cap(JNIEnv *env, jobject thiz, jint index)
{
    ...
    int maxHFRFrameWidth = 0 /*sProfiles->getVideoEncoderParamByName("enc.vid.hfr.width.max", encoder)*/;
    int maxHFRFrameHeight = 0 /*sProfiles->getVideoEncoderParamByName("enc.vid.hfr.height.max", encoder)*/;
    int maxHFRMode = 0 /*sProfiles->getVideoEncoderParamByName("enc.vid.hfr.mode.max", encoder)*/;
